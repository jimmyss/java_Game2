...
/**
 * @author Du shimao
 *  RobotControl 类包含了人机对战中机器的最短路径算法规划和机器的策略
 *  dijkstra即为用到的Dijkstra算法
 * @see Dijkstra
 */
public class RobotControl {
    ...
    /**
     * 让机器找到距离场上补给的最短距离，并将路径保存在pointsPath中
     * @param supplies
     * @param p2
     */
    ...
    /**
     * 让机器找到距离敌人的最短距离，并将路径保存在pointsPath中
     * @param p1
     * @param p2
     */
    ...
    /**
     * 控制简单模式下机器的动作，即：当场上没有补给时随机运动，当场上有补给或者自己没子弹时走最短路径吃补给
     * @param p1
     * @param p2
     */
    ...
    /**
     * 用于控制一般模式下机器的运动，加入了简单策略判断，即：自己有子弹时自动索敌，没子弹或有补给是抢补给，并且面前有敌人就发射子弹
     * @param p1
     * @param p2
     */
